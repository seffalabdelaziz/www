...
<head>
   ...
   @include('style')
	<title><?php echo translate( 25, $lang);?> - <?php echo translate( 64, $lang);?></title>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="promo-text">
                        <h2 class="avigher-title bolder fontsize30"><?php echo translate( 64, $lang);?></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?php echo translate( 64, $lang);?></li>
                    </ol>
                </div>
            </div>
        </div>
...
@if(Session::has('success'))
    ...
    <div class="row listShow">
				...
				foreach($items as $viewsor){
				
				$views_list = DB::table('products')
				->where('delete_status', '=', '')
				->where('lang_code', '=', $lang)
				->where('item_status', '=', 1)
				->where('item_token', '=' , $viewsor->item_token)
				->count();
				...
				if($lang == "en")
						  {
						    $item_id = $views[0]->item_id; 
						  }
						  else
						  {
						     $item_id = $views[0]->parent;
						  }
      ...
      $over_03 +=$review->rating;
		  ...
		  $roundeding_03 = 0; }	
                ...
                <div class="col-md-4 col-sm-4 li-item">
                
                    <div class="item-demo">
                     
                        <figure>
                            
                            <?php if(!empty($views[0]->preview_image)){?>
                            <img src="<?php echo $url;?>/local/images/media/<?php echo $views[0]->preview_image;?>" alt="">
                            <?php } else { ?>
                            ...
                            <div class="product-caption">
                                <div class="caption-cel">
                                    <div class="product-link">
                                        <div>
                                            <div>
                                                <a href="<?php echo $url;?>/item/<?php echo $item_id;?>/<?php echo $views[0]->item_slug;?>" class="radiusoff"><?php echo translate( 223, $lang);?> <span><i class="fa fa-eye"></i></span></a>
                                            </div>
                        ...
                        <div class="product-info">
                           <div class="product-header">
                                <h3 class="product-name custom_tittle col-md-8 paddingoff homenew"><a href="<?php echo $url;?>/item/<?php echo $item_id;?>/<?php echo $views[0]->item_slug;?>"><?php echo $views[0]->item_title;?></a> </h3><span class="alink col-md-4 paddingoff text-right"><?php echo $views[0]->regular_price_six_month;?> <?php echo $site_setting[0]->site_currency;?></span>
                                <span class="p-author">
