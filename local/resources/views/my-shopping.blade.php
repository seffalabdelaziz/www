                ...
                <div class="row">                                                                               
                            ...
                            <div class="row single-cart">
                                ...
                                <div class="col-sm-2 no-padding">
                                    ...
                                    <?php if(!empty($items[0]->preview_image)){?>
                                        <a href="<?php echo $url;?>/item/<?php echo $items[0]->item_id;?>/<?php echo $items[0]->item_slug;?>"><img src="<?php echo $url;?>/local/images/media/<?php echo $items[0]->preview_image;?>" alt=""></a>
                                    <?php } else { ?>  
					...
					if($today_date <= $newDate)
					{
					 ...
					 if(empty($check_one))
					 {
						...
						{
					?>
                    <a data-toggle="modal" data-target="#myModal_<?php echo $iteem->ord_id;?>" style="color:#0033CC; cursor:pointer;"><?php echo translate( 781, $lang);?></a>
                                        ...
                                        <div class="col-xs-12 marB30">
                                            <figure>
                                                <?php
														...
														?>
                                                        <a href="<?php echo $url;?>/item/<?php echo $items[0]->item_id;?>/<?php echo $items[0]->item_slug;?>"><img src="<?php echo $url;?>/local/images/media/<?php echo $items[0]->preview_image;?>" alt="" style="width:100%; max-width:350px;"></a>
                                                        <?php } else { ?>
