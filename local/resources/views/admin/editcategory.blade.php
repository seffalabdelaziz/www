...
<html lang="en">
  ...
  <body class="nav-md">
    ...
    <div class="x_title">
              ...
              <?php $url = URL::to("/"); ?>   
                   <form class="form-horizontal form-label-left" role="form" method="POST" action="{{ route('admin.editcategory') }}"  enctype="multipart/form-data" novalidate>
                     {{ csrf_field() }} 
