...
<body class="index">
    ...
    <div class="promo-area" style="background-image: url(<?php echo $url;?>/local/images/media/<?php echo $settings[0]->site_banner;?>)">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-6 col-md-12 paddingoff">
                        ...
                        <a href="<?php echo $url;?>/item/<?php echo $items_details[0]->item_id;?>/<?php echo $items_details[0]->item_slug;?>"><img src="<?php echo $url;?>/local/images/media/<?php echo $items_details[0]->preview_image;?>" alt=""></a>
                                    <?php } else { ?>  
