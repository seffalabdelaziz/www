            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-2  hidden-sm ">
                        ...
                        <a class="" href="<?php echo $url;?>"><img src="<?php echo $url.'/local/images/media/'.$setts[0]->site_logo;?>" border="0" alt="<?php echo $setts[0]->site_name;?>" /></a><?php } else {?>
                            ...
                            <ul class="board-item">
								...
								$titler = "";
                                        ...
                                        <li>
											...
											?>
                                                <img alt="" src="<?php echo $url;?>/local/images/media/<?php echo $view_item[0]->preview_image;?>">
                                            <?php } else { ?>
                                ...
                                <li class="dropdown">
    <a href="#" class="dropdown-toggle login_btn" data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="false">
...
<li class="dropdown dropdown-small display_no_icon"><?php if(!empty($language_single_cnt)){?>
                             <?php if($lang == "en"){?>
                             <a href="javascript:void(0);" class="dropdown-toggle" data-hover="dropdown"> <img src="<?php echo $url; ?>/local/images/media/<?php echo $language_single[0]->lang_flag;?>" style="width:20px; height:16px;"> <span class="value" style="text-transform:capitalize;"><?php echo $language_single[0]->lang_name;?></span> <b class="caret"></b></a><?php } else { 
					...
					if(!empty($language_cnt_view)){
                             ...
                             <a href="<?php echo $url;?>/lang/<?php echo $lang;?>" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"> <img src="<?php echo $url; ?>/local/images/media/<?php echo $language_single_view[0]->lang_flag;?>" style="width:20px; height:16px;"> <span class="value" style="text-transform:capitalize;"><?php echo $language_single_view[0]->lang_name;?></span> <b class="caret"></b></a>
                             <?php } } ?>
							 ...
							 <?php } ?>
                                 ...
                                 <li><a href="<?php echo $url;?>/lang/<?php echo $languages->lang_code;?>"><img src="<?php echo $url; ?>/local/images/media/<?php echo $languages->lang_flag;?>" style="width:20px; height:16px;"> <span style="text-transform:capitalize; font-size:12px;"><?php echo $languages->lang_name;?></span> </a></li>
                                 <?php } } ?>
                                 </ul>
                             </li>
        ...
        <div class="mobile-menu-area">
            <div class="mobile-menu">
                <div class="m-logo">
                    <a href="#"><img src="https://www.w3schools.com/images/colorpicker.gif" alt="">
                    </a>
                </div>
                <nav id="dropdown">
                    <ul>
