...
@if(Session::has('success'))
	...
	$orderupdate = DB::table('products')
						...
						->update(['featured_payment_key' => $_REQUEST['tx'], 'featured_payment_status' => 'paid']);
	...
	?>
	 ...
	 <div class="col-md-12" align="center"><h1 class="h3 black text-center"><?php echo translate( 472, $lang);?></h1>
     
     <?php if(!empty($_REQUEST['tx'])) {?><h1 class="h3 black text-center"><?php echo translate( 475, $lang);?> - <?php echo $_REQUEST['tx'];?></h1><?php } ?>
     </div>
