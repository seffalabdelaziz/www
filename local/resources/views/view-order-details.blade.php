...
<head>
   ...
   @include('style')
	<title><?php echo translate( 25, $lang);?> - <?php echo translate( 868, $lang);?></title>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="promo-text">
                        <h2 class="avigher-title bolder fontsize30"><?php echo translate( 868, $lang);?></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?php echo translate( 868, $lang);?></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container">
           ...
           <?php if(!empty($items_count)){?>
            ...
            <div class="row order_details">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="billing-details">
                        <h3 class="check-title"><?php echo translate( 871, $lang);?></h3>
                       ...
                       <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                    <label class="info-title" for="exampleInputName"><span><?php echo translate( 880, $lang);?> :</span> <?php echo $items[0]->approval_status;?> </label>
                                      </div>  
                ...
                <?php /*?><div class="col-md-6 col-sm-12 ">
                    <div class="billing-details">
                        <h3 class="check-title">customer details</h3>
                        ...
                        <div class="ship_details">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                    <label class="info-title" for="exampleInputName"><span>Name :</span> <?php echo $user_detail[0]->name;?></label>
                                      </div>  
                                    
                                </div>
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                    <label class="info-title" for="exampleInputName"><span>Phone :</span> <?php echo $user_detail[0]->phone;?></label>
                                      </div>  
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                    <label class="info-title" for="exampleInputName"><span>Email :</span> <?php echo $user_detail[0]->email;?></label>
                                      </div>  
                                    
                                </div>
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                    <label class="info-title" for="exampleInputName"><span>Gender :</span> <?php echo $user_detail[0]->gender;?></label>
                                      </div>  
            ...
            <div class="row">
                ...
                <a href="<?php echo $url;?>/my-orders" class="custom-btn"><?php echo translate( 895, $lang);?></a>
                </div>
