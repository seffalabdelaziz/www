...
<head>
   ...
   @include('style')
	<title><?php echo translate( 25, $lang);?> - <?php echo translate( 49, $lang);?></title>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="promo-text">
                        <h2 class="avigher-title bolder fontsize30"><?php echo translate( 49, $lang);?></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?php echo translate( 49, $lang);?></li>
                    </ol>
                </div>
            </div>
        </div>
...
@if(Session::has('success'))
    ...
    <div class="row listShow">
				...
				else
				{
				 ...
				 $download_as = DB::table('products')->where('item_id','=',$texter)->count();
					if(!empty($download_as))
					{	  
					$download_only = DB::table('products')->where('item_id','=',$texter)->get();
                            ...
                            <div class="product-caption">
                                <div class="caption-cel">
                                    <div class="product-link">
                                        <div>
                                            <div>
                                                <a href="<?php echo $url;?>/item/<?php echo $texter;?>/<?php echo $views->item_slug;?>"><?php echo translate( 223, $lang);?> <span><i class="fa fa-eye"></i></span></a>
                                            </div>
                                            <?php /*?><div>
