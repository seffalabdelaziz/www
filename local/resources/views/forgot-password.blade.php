...
<head>
   ...
   @include('style')
	<title><?php echo translate( 25, $lang);?> - <?php echo translate( 505, $lang);?></title>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="promo-text">
                        <h2 class="avigher-title bolder fontsize30"><?php echo translate( 505, $lang);?></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?php echo translate( 505, $lang);?></li>
                    </ol>
                </div>
            </div>
        </div>
     ...
     <div class="col-md-2"></div> 
        <div class="col-md-8">
            <div class="panel panel-default">
                <div class="panel-heading"><?php echo translate( 505, $lang);?></div>
