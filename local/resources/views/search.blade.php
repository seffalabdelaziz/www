...
<body class="index">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="promo-text">
                        <h2 class="avigher-title bolder fontsize30"><?php echo translate( 46, $lang);?></h2>
                    </div>
                </div>
            </div>
        </div>
 ...
 <div class="about-breadcrumb">
        ...
        <div class="container">
            ...
            <div class="tab-header clearfix">
                            ...
                            <ul class="product-tab pull-left" role="tablist">
                                <li role="presentation" class="active"><a href="#seller" aria-controls="seller" role="tab" data-toggle="tab"><?php echo translate( 817, $lang);?></a>
                                </li>
                                <li role="presentation"><a href="#popular" aria-controls="popular" role="tab" data-toggle="tab"><?php echo translate( 820, $lang);?></a>
                                </li>
                            </ul>
    ...
    <div class="clearfix height30"></div>
                    ...
                    <p><input data-path=".<?php echo $cat_id;?>_cat" id="<?php echo $cat_id;?>_cat" type="checkbox" <?php if($cat_id.'_cat'==$tag){?> checked <?php } ?>/> <strong><?php echo $views->cat_name;?></strong></p>
					  ...
					  ?>
					   ...
					   ?>
                      <p class="left10"><input data-path=".<?php echo $subcat_id;?>_subcat" id="<?php echo $subcat_id;?>_subcat" type="checkbox" <?php if($subcat_id.'_subcat'==$tag){?> checked <?php } ?>/> <?php echo $subs->subcat_name;?></p>
                ...
                <div class="col-md-9 col-sm-12">
                    ...
                    <div class="item-demo">
                        ...
                        <div class="product-info">
                            ...
                            <span class="theme star_text_hide"><span class="<?php echo $roundeding_03.'_star';?>"><?php echo $roundeding_03.'_star';?></span></span>
                           <?php } } ?>
                                <h3 class="product-name title col-md-8 paddingoff"><a href="<?php echo $url;?>/item/<?php echo $item_id;?>/<?php echo $views->item_slug;?>"><?php echo $views->item_title;?></a></h3> <span class="alink col-md-4 paddingoff text-right price_value"><?php echo $views->regular_price_six_month;?> <?php echo $site_setting[0]->site_currency;?></span>
                                <span class="p-author">
					...
					$view_like_as = 0;
									...
									$review_count_04 = DB::table('product_rating')
														->where('item_id', '=', $item_id)
														->count();
														
														if(!empty($review_count_04))
														{
														$review_value_04 = DB::table('product_rating')
																	   ->where('item_id', '=', $item_id)
																	   ->get();
                    ...
                    <div class="item-demo">
                        ...
                        <div class="product-info">
                            ...
                            <span class="theme star_text_hide"><span class="<?php echo $roundeding_04.'_star';?>"><?php echo $roundeding_04.'_star';?></span></span>
                           <?php } } ?>
					...
					$view_like_as = 0;
									    ...
									    $review_count_05 = DB::table('product_rating')
														->where('item_id', '=', $item_id)
														->count();
														
														if(!empty($review_count_05))
														{
														$review_value_05 = DB::table('product_rating')
																	   ->where('item_id', '=', $item_id)
																	   ->get();
                           ...
                           <?php } } ?>
                                ...
                                <?php /*?><P><?php echo substr(html_entity_decode($views->item_desc),0,200); ?></P><?php */?>
                            </div>
                            <div class="product-meta">
                                <span class="meta-download">
                                    <i class="fa fa-cloud-download"></i><?php echo $view_download_as;?>
					...
					$view_like_as = 0;
									...
									$review_count_06 = DB::table('product_rating')
														->where('item_id', '=', $item_id)
														->count();
														
														if(!empty($review_count_06))
														{
														$review_value_06 = DB::table('product_rating')
																	   ->where('item_id', '=', $item_id)
																	   ->get();
