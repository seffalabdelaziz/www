...
<div class="promo-area" style="background-image: url(<?php echo $url;?>/local/images/media/<?php echo $setts[0]->site_banner;?>)">
   ...
   <div class="about-breadcrumb">
    ...
    <div class="fontsize21 blacker ellipsis"><a href="<?php echo $url;?>/blog/<?php echo $nquery->post_slug;?>" class="blacker decorationoff"><?php echo $nquery->post_title;?></a></div>
    ...
    <div class="text-left"><a href="<?php echo $url;?>/blog/<?php echo $nquery->post_slug;?>" class="custom-btn"><?php echo translate( 766, $lang);?></a></div>
    </div>
                    ...
                    <div class="item-demo">
                        ...
                        <div class="product-info">
                            <div class="product-header">
                                <h3 class="product-name custom_tittle col-md-8 paddingoff"><a href="<?php echo $url;?>/item/<?php echo $item_id;?>/<?php echo $views->item_slug;?>"><?php echo $views->item_title;?></a> </h3><span class="alink col-md-4 paddingoff text-right"><?php echo $views->regular_price_six_month;?> <?php echo $site_setting[0]->site_currency;?></span>
                                <span class="p-author">
                                    <a href="<?php echo $url;?>/user/<?php echo $user_slug;?>">@<?php echo $user_name;?></a>
                                </span>
                            </div>
