    ...
    <form class="form-horizontal" role="form" method="POST" action="{{ route('dashboard') }}" id="formID" enctype="multipart/form-data">
		...
		<div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label"><?php echo translate( 427, $lang);?></label>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label"><?php echo translate( 430, $lang);?></label>
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="password" class="col-md-4 control-label"><?php echo translate( 433, $lang);?></label>
						...
						<input type="hidden" name="savepassword" value="<?php echo $editprofile[0]->password;?>">
						 ...
						 <div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
                            <label for="phone" class="col-md-4 control-label"><?php echo translate( 415, $lang);?></label>
						...
						<div class="form-group">
                            <label for="gender" class="col-md-4 control-label"><?php echo translate( 436, $lang);?></label>
						...
						<div class="form-group">
                            <label for="phoneno" class="col-md-4 control-label"><?php echo translate( 439, $lang);?></label>
				...
				$userphoto="/media/";
					...
					<img src="<?php echo $url.$path;?>" class="img-responsive itemauthor" alt="">
						...
						<div class="form-group">
                            <label for="gender" class="col-md-4 control-label"><?php echo translate( 442, $lang);?></label>
		...
		<div class="col-md-6">
           ...
           <div class="form-group">
                            <label for="phoneno" class="col-md-4 control-label"><?php echo translate( 445, $lang);?></label>
				...
				$userphoto="/media/";
                 ...
                 <div class="form-group">
                            <label for="name" class="col-md-4 control-label"><?php echo translate( 355, $lang);?></label>
                     ...
                     <div class="form-group">
                            <label for="name" class="col-md-4 control-label"><?php echo translate( 343, $lang);?></label>
                      ...
                      <div class="form-group">
                            <label for="name" class="col-md-4 control-label"><?php echo translate( 448, $lang);?></label>
               ...
               <div class="form-group">
                            <label for="gender" class="col-md-4 control-label"><?php echo translate( 1131, $lang);?></label>
               ...
               <div class="form-group">
                            <label for="gender" class="col-md-4 control-label"><?php echo translate( 451, $lang);?></label>
                        ...
                        <div class="form-group">
                            <label for="name" class="col-md-4 control-label"><?php echo translate( 460, $lang);?></label>
               ...
               <?php } ?>
				...
				<div class="form-group">
							...
							<?php if(config('global.demosite')=="yes"){?><button type="button" class="btn btn-primary btndisable"><?php echo translate( 463, $lang);?></button> <span class="disabletxt">( <?php echo config('global.demotxt');?> )</span><?php } else { ?>
