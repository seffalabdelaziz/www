            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="promo-text">
                        <h2 class="avigher-title bolder fontsize30"><?php echo translate( 325, $lang);?></h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="billing-details">
                        ...
                        <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group">
                                    <label class="info-title" for="exampleInputName"><input type="checkbox" style="margin-top:5px; margin-right:5px;" value="1" name="enable_ship" id="enable_ship" class="enable_ship" onChange="valueChanged()"> <strong><?php echo translate( 364, $lang);?> </strong></label>
