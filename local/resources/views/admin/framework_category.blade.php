       ...
       @include('admin.top')
        ...
        <div class="right_col" role="main">
		 ...
		 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Software Framework Category</h2>
                  ...
                  <form action="{{ route('admin.framework_category') }}" method="post">
                 ...
                 {{ csrf_field() }}
				  ...
				  <?php } else { ?>
				  <a href="<?php echo $url;?>/admin/add_framework_category" class="btn btn-primary">Add Category</a>
				  <?php } ?>
                  <div class="x_content">
          ...
          <span class="sub"></span> Select All </button></th>
             ...
             <?php 
				  ...
				  <?php } else { ?>
						  <a href="<?php echo $url;?>/admin/edit_framework_category/{{ $service->id }}" class="btn btn-success">Edit</a>
						  <?php } ?>
				   <?php if(config('global.demosite')=="yes"){?>
				   <a href="#" class="btn btn-danger btndisable">Delete</a>  <span class="disabletxt">( <?php echo config('global.demotxt');?> )</span>
				  <?php } else { ?>
						 <a href="<?php echo $url;?>/admin/framework_category/{{ $service->id }}" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete this?')">Delete</a>
