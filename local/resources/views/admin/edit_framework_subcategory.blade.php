...
<html lang="en">
  ...
  <body class="nav-md">
    ...
    <div class="x_title">
              ...
              <?php $url = URL::to("/"); ?>   
                   <form class="form-horizontal form-label-left" role="form" method="POST" action="{{ route('admin.edit_framework_subcategory') }}" enctype="multipart/form-data" novalidate>
                     {{ csrf_field() }} 
                     
                     
                      <span class="section">Edit Software Framework Sub Category</span>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
					  ...
					  {
					      $count_other = DB::table('subcategory')
