            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="promo-text">
                        <h2 class="avigher-title bolder fontsize30"><?php echo translate( 217, $lang);?></h2>
                    </div>
                </div>
            </div>
        </div>
                     ...
                     <?php if($free_status=="yes"){?><div class="ribbon"><span><?php echo translate( 220, $lang);?></span></div><?php } ?>
                        ...
                        <div class="product-info">
                            <div class="product-header">
                                <h3 class="product-name custom_tittle col-md-8 paddingoff homenew"><a href="<?php echo $url;?>/item/<?php echo $item_id;?>/<?php echo $views->item_slug;?>"><?php echo $views->item_title;?></a> </h3><span class="alink col-md-4 paddingoff text-right"><?php echo $views->regular_price_six_month;?> <?php echo $site_setting[0]->site_currency;?></span>
                                <span class="p-author">
