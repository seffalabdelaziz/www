					...
					<div class="item form-group">
					 ...
					 <?php /*?> <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="site_live_chat" name="site_live_chat" class="form-control col-md-7 col-xs-12" style="min-height:200px;align-content:left; text-align: left;">
                          <?php if($site_live_chat!=""){ echo $site_live_chat; } ?></textarea>
