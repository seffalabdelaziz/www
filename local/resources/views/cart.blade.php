            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="promo-text">
                        <h2 class="avigher-title bolder fontsize30"><?php echo translate( 274, $lang);?></h2>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-sm-2" align="center">
                                    <div class="cart-prev">
                                        ...
                                        <?php
                                                        ...
                                                        <a href="<?php echo $url;?>/item/<?php echo $texter;?>/<?php echo $view_item[0]->item_slug;?>" class="entry-thumbnail"><img src="<?php echo $url;?>/local/images/media/<?php echo $view_item[0]->preview_image;?>" alt="" ></a>
                                                        <?php } else { ?>
