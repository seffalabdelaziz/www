...
<?php } ?>
					  ...
					  <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Earnings
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="wallet" class="form-control col-md-7 col-xs-12"  name="wallet" value="<?php echo $users[0]->wallet; ?>" type="text">
                        <?php echo $settings[0]->site_currency;?>
					   </div>
                      </div>
					  <?php } else { ?>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12" style="margin-top:10px; color:#FF0000;">
                          <?php echo $users[0]->wallet; ?> <?php echo $settings[0]->site_currency;?>
