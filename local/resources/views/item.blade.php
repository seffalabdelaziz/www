            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="promo-text">
                        <h2 class="avigher-title bolder fontsize30"><?php echo $item_title;?></h2>
                    </div>
                </div>
            </div>
        </div>
	...
	@endif
                ...
                <div class="col-md-8 col-sm-12">
                    ...
                    <div class="single-product">
                        ...
                        <div class="col-md-10">
                        <h3 class="product-title"><?php echo $item_title;?></h3>
                        </div>
                        <?php
						   /* item meta */
		...
		/* item meta */
                        ...
                        <?php if(Auth::check()) 
							  ...
							  {
							  $get_viewer = DB::table('product_liked')->where('item_id','=',$item_id)->where('user_id','=',Auth::user()->id)->count();
						?>	  
		...
		<video id="v1" loop controls>
               ...
               $('#vidBox').VideoPopUp({
                  ...
                  <?php } ?>      
                        ...
                        <div class="clearfix"></div>
                            ...
                            <?php if($img_url!=""){?><img src="<?php echo $img_url;?>" alt=""><?php } ?>
                        ...
                        <div class="demo-social">
                            ...
                            <?php if(!empty($demo_url)){ if($demo_url == "#" ) {?>
                            ...
                            ?>
                            <a href="<?php echo $prev_url;?>" class="custom-btn_review" target="_blank"><?php echo translate( 541, $lang);?> <i class="fa fa-heart-o"></i> </a><?php } } ?>
			...
			<img class="thumbnail img-responsive" title="" src="<?php echo $url;?>/local/images/media/<?php echo $gallery->image;?>">
		</div>
            ...
            <a class="carousel-control new-control right" href="#modal-carousel" data-slide="next"><i class="fa fa-chevron-right"></i></a>
                        ...
                        <div class="s-product-tab">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="item_details">
								...
								$item_rate = DB::table('product_rating')
                                            ...
                                            <li>
                                                <div class="single-comment">
                                                    ...
                                                    <?php if(!empty($user_details[0]->photo)){?>
                                                        <img src="<?php echo $url;?>/local/media/<?php echo $user_details[0]->photo;?>" alt="">
                                                    <?php } else { ?> 
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="comments">
                                    ...
                                    <div class="comment-area">
                                        <ol class="comment-wrap listShow1">
										   ...
										   ?> 
											...
											$sub_comment_count = DB::table('product_comment')
														->where('item_token','=',$item_token)
														->where('item_id','=',$item_id)
                                            ...
                                            <li>
                                                <div class="single-comment">
                                                    <div class="comment-thumb">
                                                        ...
                                                        <img src="<?php echo $url;?>/local/images/media/<?php echo $user_photo[0]->photo;?>" alt="">
                                                        <?php } else { ?>
											...
											$sub_comment_view = DB::table('product_comment')
														->where('item_token','=',$item_token)
														->where('item_id','=',$item_id)
														->where('comm_parent','=',$comment_view->comm_id)
														->get();
                                        ...
                                        <ol class="comment-wrap listShow2">
                                            ...
                                            <li>
                                                <div class="single-comment">
                                                    <div class="comment-thumb">
                                                    <?php if(!empty($user_photo[0]->photo)){?>
                                                        <img src="<?php echo $url;?>/local/images/media/<?php echo $user_photo[0]->photo;?>" alt="" class="round_img">
                                                        <?php } else { ?>
									...
									$(document).ready(function(){
                                            ...
                                            <div id="text<?php echo $comment_view->comm_id;?>" style="display:none; margin-top:10px;">
                                                ...
                                                <img src="<?php echo $url;?>/local/images/media/<?php echo $user_photo_url;?>" border="0" class="round_img">
                                                <?php } else {?>
                                                <img src="<?php echo $url;?>/local/images/nophoto.jpg" border="0" class="round_img"/>
                                                <?php } ?>
                                                </div>
                                                <div class="col-md-11 text-right">
                                                      ...
                                                      <input type="text" class="form-control validate[required] text-input"  name="comm_text_reply[]" style="overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 30px;">  
                                            ...
                                            {{ csrf_field() }}
                                                ...
                                                <input type="hidden" name="comm_id" value="0">
                                                      ...
                                                      <input type="text" class="form-control validate[required] text-input" id="comm_text" name="comm_text" style="overflow: hidden; overflow-wrap: break-word; resize: horizontal; height: 30px;">  
                                                        <div class="height10"></div>
               ...
               <?php
						   /* item meta */
		$check_item_file = DB::table('products_meta')
		        ->where('item_token', '=' , $item_token)
                       ...
                       {{ csrf_field() }}
                        ...
                        <div class="product-widget">
                           <h3 class="prodect-info-heading"><?php echo translate( 556, $lang);?></h3>
                            ...
                            <div class="col-md-4">
                            <a href="<?php echo $url;?>/user/<?php echo $author_slug;?>"><?php if(!empty($author_photo)){?><img src="<?php echo $url;?>/local/images/media/<?php echo $author_photo;?>" class="itemauthor" border="0" alt="<?php echo $author;?>" /><?php } else { ?><img src="<?php echo $url;?>/local/images/nophoto.jpg" class="itemauthor" border="0" alt="<?php echo $author;?>" /><?php } ?></a>
                            </div>
                            
                            <div class="col-md-8">
                            <h3 style="margin-top:30px;"><a href="<?php echo $url;?>/user/<?php echo $author_slug;?>" class="black"><?php echo $author;?></a></h3>
                            </div>
                            </div>
                    ...
                    <div class="item-demo">
                        ...
                        <div class="product-info">
                            <div class="product-header">
                                <h3 class="product-name custom_tittle col-md-8 paddingoff"><a href="<?php echo $url;?>/item/<?php echo $item_id;?>/<?php echo $views->item_slug;?>"><?php echo $views->item_title;?></a> </h3><span class="alink col-md-4 paddingoff text-right"><?php echo $views->regular_price_six_month;?> <?php echo $setts[0]->site_currency;?></span>
                                <span class="p-author">
