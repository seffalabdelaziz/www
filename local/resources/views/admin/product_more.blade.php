                    ...
                    <div class="item form-group">
                     ...
                     <div style="clear:both; height:20px;"></div>
                      ...
                      foreach($pieces as $view)
					  {
						  ...
						  if($ctype=="cat")
						  {
						      $category_first_count = DB::table('category')
									            ->where('id','=',$cid)
									            ->count();
						  ...
						  else if($ctype=="subcat")
						  {
						      ...
						      $category_first_count = DB::table('subcategory')
									            ->where('subid','=',$cid)
									            ->count();
							  if(!empty($category_first_count))
							  {					
                      ...
                      <div class="item form-group">
						...
						$path ='/local/images/media/'.$single_items[0]->preview_image;
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <a href="<?php echo $url;?>/local/images/media/<?php echo $single_items[0]->main_file;?>" style="color:#0000CC; text-decoration:underline;" download><?php echo $single_items[0]->main_file;?></a>
